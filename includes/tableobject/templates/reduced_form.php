...
<?php if(isset($_GET[$this->instance_name.'id']) && $_GET[$this->instance_name.'id']) { ?>
	<h3>Update <?php echo $this->title['singular'];?> <a class="add-new-h2" href="/wp-admin/admin.php?page=<?php echo $this->page;?>">cancel</a></h3>
<?php } else { ?>
	<h3>Add New <?php echo $this->title['singular'];?> <a class="add-new-h2" href="/wp-admin/admin.php?page=<?php echo $this->page;?>">cancel</a></h3>
<?php } ?>
